...
## [2.26.0](https://github.com/zunda-pixel/supabase-swift/compare/v2.25.0...v2.26.0) (2025-02-26)


### Features

* add Android support ([#673](https://github.com/zunda-pixel/supabase-swift/issues/673)) ([6ec2cdd](https://github.com/zunda-pixel/supabase-swift/commit/6ec2cdd994f80cc754f310b4aaf307671454f992))
...
* **auth:** add new error codes ([#586](https://github.com/zunda-pixel/supabase-swift/issues/586)) ([1721c08](https://github.com/zunda-pixel/supabase-swift/commit/1721c08c7710e0cba1390962441fe595b613072c))
...
* **functions:** invoke function with custom query params ([#376](https://github.com/zunda-pixel/supabase-swift/issues/376)) ([b4b9276](https://github.com/zunda-pixel/supabase-swift/commit/b4b9276512acccc673c36e35f06e69755e2a5dc7))
...
* **postgrest:** add read-only mode for RPC ([#600](https://github.com/zunda-pixel/supabase-swift/issues/600)) ([d81fc86](https://github.com/zunda-pixel/supabase-swift/commit/d81fc865409821dc0816c930d2d537a126b4fe06))
...
* **realtime:** add `system` event ([#589](https://github.com/zunda-pixel/supabase-swift/issues/589)) ([1176dea](https://github.com/zunda-pixel/supabase-swift/commit/1176dea4d90f353ae777a633fc079dedf98276ff))
...
* **realtime:** add predefined filters instead of regular `String` ([#669](https://github.com/zunda-pixel/supabase-swift/issues/669)) ([3dc9b82](https://github.com/zunda-pixel/supabase-swift/commit/3dc9b82e90a5158664d163caeb397e220f58d8dd))
* **realtime:** pull access token mechanism ([#615](https://github.com/zunda-pixel/supabase-swift/issues/615)) ([c88dd36](https://github.com/zunda-pixel/supabase-swift/commit/c88dd3675b8bc7da93c71847ff9ba9862323ff8d))
...
* **auth:** `URLError` coercion for `RetryableError` causing session to be deleted ([#597](https://github.com/zunda-pixel/supabase-swift/issues/597)) ([d67b7cf](https://github.com/zunda-pixel/supabase-swift/commit/d67b7cf850d43c2a8ecf39feedfc39528f55f139))
* **auth:** add missing channel param to signUp method ([#625](https://github.com/zunda-pixel/supabase-swift/issues/625)) ([3a36ab7](https://github.com/zunda-pixel/supabase-swift/commit/3a36ab74c4fbd9224c03dabd88046bba49b0de9c))
...
* **auth:** header being overridden ([#379](https://github.com/zunda-pixel/supabase-swift/issues/379)) ([866a039](https://github.com/zunda-pixel/supabase-swift/commit/866a0395043030dd1574deb97360e2d47040efae))
* **auth:** incorrect error when error occurs during PKCE flow ([#592](https://github.com/zunda-pixel/supabase-swift/issues/592)) ([84ce6f2](https://github.com/zunda-pixel/supabase-swift/commit/84ce6f29b2ee2192b57d8ff7c36af3378c696653))
* **auth:** make AuthClient an Actor ([#664](https://github.com/zunda-pixel/supabase-swift/issues/664)) ([bdf1961](https://github.com/zunda-pixel/supabase-swift/commit/bdf19614b35b76281f2a50e785b6d21fa9578e40))
...
* general auth improvements ([#561](https://github.com/zunda-pixel/supabase-swift/issues/561)) ([5f4c0f2](https://github.com/zunda-pixel/supabase-swift/commit/5f4c0f256c74beb47ce2a42951014504ba798dd6))
...
* issue with MainActor isolated property on Swift 5.9 ([#577](https://github.com/zunda-pixel/supabase-swift/issues/577)) ([7266b64](https://github.com/zunda-pixel/supabase-swift/commit/7266b64e1e0b58fc893693fa80872b6d77bf1555))
...
* Make the return value of accessToken nullable ([#641](https://github.com/zunda-pixel/supabase-swift/issues/641)) ([af9b774](https://github.com/zunda-pixel/supabase-swift/commit/af9b77453892da562c444e94ff7538051a2dd0a4))
...
* **postgrest:** update parameter of `is` filter to allow only `Bool` or `nil` ([#382](https://github.com/zunda-pixel/supabase-swift/issues/382)) ([4ba1c7a](https://github.com/zunda-pixel/supabase-swift/commit/4ba1c7a6c5a13c0a2b4b067aad5c747d7d621e93))
...
* **realtime:** auto reconnect after calling disconnect, and several refactors ([#627](https://github.com/zunda-pixel/supabase-swift/issues/627)) ([1887f4f](https://github.com/zunda-pixel/supabase-swift/commit/1887f4f376e172bb7fbcec84506fea6c4797fde7))
...
* **realtime:** lost `postgres_changes` on resubscribe ([#585](https://github.com/zunda-pixel/supabase-swift/issues/585)) ([fabc07d](https://github.com/zunda-pixel/supabase-swift/commit/fabc07dac833aa94e35bf932899dfb5d1a868cfb))
* **realtime:** prevent sending expired tokens ([#618](https://github.com/zunda-pixel/supabase-swift/issues/618)) ([595277b](https://github.com/zunda-pixel/supabase-swift/commit/595277b5eb35b8b76bbb000d44fc221c4d3298f1))
* **realtime:** remove jwt check ([#658](https://github.com/zunda-pixel/supabase-swift/issues/658)) ([4c95559](https://github.com/zunda-pixel/supabase-swift/commit/4c955592c58c7d0aafbd0c32ae8a85e213303caa))
...
* **realtime:** Set default heartbeat interval to 25s ([#667](https://github.com/zunda-pixel/supabase-swift/issues/667)) ([14c590d](https://github.com/zunda-pixel/supabase-swift/commit/14c590d08898e5a3c1c131ad704966d73df7e538))
* remove kSecUseDataProtectionKeychain ([#574](https://github.com/zunda-pixel/supabase-swift/issues/574)) ([554f916](https://github.com/zunda-pixel/supabase-swift/commit/554f91689eb13c1a923a53bddb5d194e6b80328a))
* remove usage of `nonisolated(unsafe)` from codebase ([#638](https://github.com/zunda-pixel/supabase-swift/issues/638)) ([3d87608](https://github.com/zunda-pixel/supabase-swift/commit/3d876089b2429389f0e16e4238cc11bd444a1254))
...
* revert AnyJSON codable ([#580](https://github.com/zunda-pixel/supabase-swift/issues/580)) ([bfb6ed7](https://github.com/zunda-pixel/supabase-swift/commit/bfb6ed7b9b69123dc5cc16458da62ee3546eaf98))
* **storage:** cache control ([#551](https://github.com/zunda-pixel/supabase-swift/issues/551)) ([8a2b196](https://github.com/zunda-pixel/supabase-swift/commit/8a2b19690cf165c80454ff6388cb9a202b04172c))
